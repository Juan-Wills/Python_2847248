...
if Test == 'prestamo':
    ...
    loan1 = Prestamo('1', 'Don quijote de la mancha', 'santi@gmail.com', '20/07/2020', '20/08/2020')
    loan2 = Prestamo('2', 'El samurai secreto', 'juan@gmail.com', '14/06/2025', '21/04/2025')
...
if Test == 'usuario':
    ...
    user1 = Usuario('1', "Alice", "Smith", "alice@gmail.com", 'Barrio morena de la sal', '3220268742', afiliacion= True)
    print(user1)
    print("-" * 50)

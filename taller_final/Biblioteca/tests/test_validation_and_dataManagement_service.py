...
if test_mode:
    def test_get_feat():
        ...
        assert vdm.get_feat('libro', 10) is False  # Assuming it returns False for invalid index

    def test_save():
        # Test saving a book to a file
        usuario = Usuario('nombre', 'apellido', 'correo', 'residencia', 'telefono', True)
        vdm.save(r'C:\\Users\\juand\\Documents\\Python\\Python_2847248\\taller_final\\Biblioteca\\data\\usuarios.json', {'usuarios': [usuario]})
